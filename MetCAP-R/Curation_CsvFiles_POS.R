...
## This script is a tool to facilitate the curation of data obtained by LC-MS/MS in POSITIVE ion mode and processed by XCMS and CAMERA on W4M.
...
write.xlsx(datamerged, file = "FileNameB.xlsx",          
           sheetName = "Sheet1",                               
